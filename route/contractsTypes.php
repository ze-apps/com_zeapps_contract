...
Routeur::post("/com_zeapps_contract/contracts/type/save", 'App\\com_zeapps_contract\\Controllers\\ContractsTypes@save');
Routeur::get('/com_zeapps_contract/contracts/types/view', 'App\\com_zeapps_contract\\Controllers\\View@contractsTypesView');
Routeur::post("/com_zeapps_contract/contracts/types/delete/{id}", 'App\\com_zeapps_contract\\Controllers\\Contracts@delete');

// Modal
Routeur::get('/com_zeapps_contract/contracts/types/modal_liste/', 'App\\com_zeapps_contract\\Controllers\\View@contractsFormModal');
Routeur::post("/com_zeapps_contract/contracts/types/modal/{limit}/{offset}", 'App\\com_zeapps_contact\\Controllers\\Contracts@modal');

//////////////////////////
//////// TARIFS //////////
//////////////////////////
///
Routeur::get("/com_zeapps_contract/contracts/types/tarifs/modal_edit/", 'App\\com_zeapps_contract\\Controllers\\View@contractTypeTarifEditFormModal');
